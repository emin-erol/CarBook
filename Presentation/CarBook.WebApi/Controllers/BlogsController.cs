...
namespace CarBook.WebApi.Controllers
{
    ...
    public class BlogsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetLast3BlogsWithAuthorsetBlog()
        {
            var values = await _mediator.Send(new GetLast3BlogsWithAuthorsQuery());
            return Ok(values);
        }

        [HttpGet("GetBlogsWithAuthorsList")]
        public async Task<IActionResult> GetBlogsWithAuthorsList()
        {
        ...
        public async Task<IActionResult> RemoveBlog(int id)
        {
            ...
            return Ok("Blog Information Has Been Removed");
        }
    }
}
