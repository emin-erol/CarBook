...
using CarBook.Application.Helper;
...
{
    cfg.AddProfile(new CarBookMapper());
});
...
builder.Services.AddScoped(typeof(IBlogRespository), typeof(BlogRepository));
...
builder.Services.AddScoped<GetCarCountsByYearQueryHandler>();
